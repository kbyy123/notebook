...
| 分类 | 题目 |
| :--- | :--- |
| **链表 - 反转系列** | 🟢 [206. 反转链表](#206-反转链表) |
| | 🟡 [92. 反转链表 II](#92-反转链表-ii) |
| | 🔴 [25. K 个一组翻转链表](#25-k-个一组翻转链表) |
| | 🟢 [24. 两两交换链表中的节点](#24-两两交换链表中的节点) |
| | 🟡 [445. 两数相加 II](#445-两数相加-ii) |
| | 🟡 [2816. 翻倍以链表形式表示的数字](#2816-翻倍以链表形式表示的数字) |
| **链表 - 快慢指针** | 🟢 [876. 链表的中间结点](#876-链表的中间结点) |
| | 🟡 [141. 环形链表](#141-环形链表) |
| | 🔴 [142. 环形链表 II](#142-环形链表-ii) |
| | 🟠 [143. 重排链表](#143-重排链表) |
| | 🟢 [234. 回文链表](#234-回文链表) |
| **链表 - 删除系列** | 🟢 [237. 删除链表中的节点](#237-删除链表中的节点) |
...
与[删除排序链表中的重复元素](https://leetcode.cn/problems/remove-duplicates-from-sorted-list/)的不同点在于头结点可能会被删除，因此要创建一个哨兵结点．
