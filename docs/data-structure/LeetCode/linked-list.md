...
| 分类 | 题目 |
| :--- | :--- |
| **链表 - 反转系列** | 🟢 [206. 反转链表](#206) |
| | 🟡 [92. 反转链表 II](#92-ii) |
| | 🔴 [25. K 个一组翻转链表](#25-k) |
| | 🟢 [24. 两两交换链表中的节点](#24) |
| | 🟡 [445. 两数相加 II](#445-ii) |
| | 🟡 [2816. 翻倍以链表形式表示的数字](#2816) |
| **链表 - 快慢指针** | 🟢 [876. 链表的中间结点](#876) |
| | 🟡 [141. 环形链表](#141) |
| | 🔴 [142. 环形链表 II](#142-ii) |
| | 🟠 [143. 重排链表](#143) |
| | 🟢 [234. 回文链表](#234) |
| **链表 - 删除系列** | 🟢 [237. 删除链表中的节点](#237) |
| | 🟢 [19. 删除链表的倒数第 N 个结点](#19-n) |
| | 🟢 [83. 删除排序链表中的重复元素](#83) |
| | 🔴 [82. 删除排序链表中的重复元素 II](#82-ii)|
| | 🟢 [203. 移除链表元素](#203)|
| | 🟢 [3217. 从链表中移除在数组中存在的节点](#3217)|
| | 🟢 [2487. 从链表中移除节点](#2487)|
...
[反转链表](#206)和[两数相加](https://leetcode.cn/problems/add-two-numbers/)的混合，先将两个链表反转后转化为两数相加问题，计算出答案后再次反转即可．
...
我们可以通过[链表的中间结点](#876)和[反转链表](#206)，将中间点及以后的结点反转并得到右指针．
...
与[删除排序链表中的重复元素](#83)的不同点在于头结点可能会被删除，因此要创建一个哨兵结点．
